...
In the process of getting on the latest cdk release, I opened [two](https://github.com/cashubtc/cdk/pull/1750) [PRs](https://github.com/cashubtc/cdk/pull/1742) (one still in progress) and I updated hashpool to use batched minting (which the cashu team shipped in my absence). Squad goals. \o/
